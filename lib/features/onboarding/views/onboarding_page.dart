...
import 'package:myapp/features/onboarding/bloc/onboarding_bloc.dart';
                  ...
                  children: [
                    Text(list[currentPage].title,
                        style: DistroTypography.bodyLargeSemiBold.copyWith(
                            color: DistroColors.tertiary_600, fontSize: 22)),
                    const VerticalSeparator(height: 1),
                    Text(
                      list[currentPage].description,
                      style: DistroTypography.bodyLargeRegular.copyWith(
                      ...
                      child: Row(
                        ...
                        children: [
                                ...
                                itemBuilder: (context, index) {
                                  return Container(
                                    ...
                                    width: SizeConfig.safeBlockHorizontal *
                                        (index == currentPage ? 12 : 3),
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(24),
                                        color: index == currentPage
                                            ? DistroColors.primary_500
                                            : DistroColors.primary_300),
                                  );
                                },
                          ...
                          DistroElevatedButton(
                              label: Text(list[currentPage].buttonLabel,
                                  style: DistroTypography.bodySmallSemiBold
                                      .copyWith(color: DistroColors.white)),
                              onPressed: () {
